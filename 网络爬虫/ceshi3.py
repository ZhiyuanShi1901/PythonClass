...
# option.add_argument(r'user-data-dir=C:\Users\14433\AppData\Local\Microsoft\Edge\User Data')  # 此处输入chrome的userdata地址，即你是用的chrome的地址
webdriver.FirefoxOptions
bro = webdriver.Edge(executable_path=r'C:\Users\14433\Downloads\edgedriver_win64\MicrosoftWebDriver.exe')  # 此处填chromedriver.exe所在的地址，填在r''里。
...
webs = []
while(i>=10000):
    yiyi = bro.find_elements_by_xpath(f'//*[@id="normalthread_{i}"]/tr/th/a[2]')
    webs.extend(yiyi)
    i=i-1
    print(f"{i}保存完成")
    print(yiyi)
